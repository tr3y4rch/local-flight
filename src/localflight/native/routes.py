...
CLIENT_ROUTES: tuple[NativeRoute, ...] = (
    ...
    NativeRoute("setup.access_catalog", "Load Relay Access availability", "GET", "/api/setup/access/catalog", "client", "setup"),
    NativeRoute("setup.access_deactivate", "Release Relay Access", "POST", "/api/setup/access/deactivate", "client", "setup"),
    NativeRoute("setup.complete", "Complete setup", "POST", "/api/setup/complete", "client", "setup"),
    NativeRoute("setup.activate", "Activate Relay Access", "POST", "/api/setup/activate", "client", "setup"),
    NativeRoute("setup.activation_status", "Check Relay Access", "POST", "/api/setup/client-status", "client", "setup"),
    NativeRoute("setup.test_activation", "Test Relay Access", "POST", "/api/setup/test-activation", "client", "setup"),
