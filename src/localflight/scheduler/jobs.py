...
def _fetch_vatsim(cfg: AppConfig) -> List[Flight]:
    ...
    for f in flights:
        ...
        enriched.append(Flight(
            ...
            sold_as=f.sold_as,
            marketing_airline_name=f.marketing_airline_name,
            marketing_airline_iata=f.marketing_airline_iata,
            marketing_airline_icao=f.marketing_airline_icao,
            ...
            provider_codeshare_status=f.provider_codeshare_status,
            provider_movement_key=f.provider_movement_key,
            identity_evidence=f.identity_evidence,
            origin=f.origin,
            destination=f.destination,
            aircraft_type=f.aircraft_type,
            aircraft_type_full=f.aircraft_type_full,
            aircraft_registration=f.aircraft_registration,
            gate=f.gate,
            terminal=f.terminal,
            stand=f.stand,
            gate_source=f.gate_source,
            terminal_source=f.terminal_source,
            gate_confidence=f.gate_confidence,
            terminal_confidence=f.terminal_confidence,
            ops_location_notes=f.ops_location_notes,
            status=f.status,
            times=f.times,
