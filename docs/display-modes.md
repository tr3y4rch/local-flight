...
In `0.7.1`, the browser UI follows the same visual and information hierarchy as
...
The mobile app runs on iPhone, iPad, and Android and has two modes. Testing source for iOS build `15` and Android versionCode 18 uses the same `0.7.1` data and privacy contract as desktop, Linux server, and Pi hosts.
