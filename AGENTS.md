...
## Current 0.5.1 handoff snapshot (2026-07-10)
...
- Existing `dist/` artifacts from older lines are stale for public release. Rebuild expected artifacts after validation: `LocalFlight-0.5.1-Setup.exe`, `LocalFlight-0.5.1-macos.pkg`, and `LocalFlight-pi-source-0.5.1.zip`.
