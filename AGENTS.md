...
- **Verification** — `.venv/bin/python -m pytest tests -q` returned `385 passed`; `cd mobile && npm run typecheck && npm run doctor` passed with Expo Doctor `18/18`; `git diff --check` passed.
