...
## Current 0.2.7 handoff snapshot (2026-05-27)
...
- Preliminary `0.2.8` notes exist for post-RC polish only. Keep `pyproject.toml` and artifacts at `0.2.7` until a deliberate version bump; public/user docs may link to `docs/release-notes-0.2.8.md` as preliminary notes.
