...
- `src/localflight/native/app.py` is the native Qt user shell: top-nav layout, Display/FIDS/Radar/Matrix/Settings/Admin/History/Logs/Report pages, native radar canvas, FIDS detail drawer, and user-only admin overview.
