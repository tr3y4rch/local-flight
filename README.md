...
Hit the **ðŸ› Report** button in the nav bar from anywhere in the app. Your report — along with your Local Flight version, platform, and airport — goes directly to the developer. No account required.
